...
<html>
  <head>
    ...
    <noscript><link rel="stylesheet" href="resources/introduce/css/noscript.css" /></noscript>
  </head>
  <body class="is-preload">
    ...
    <div id="wrapper">
      ...
      <header id="header" class="alt">
        <a href="home" class="logo"><strong>Hyunwoo</strong> <span>introduce</span></a>
        <nav>
          <a href="#menu">Menu</a>
        </nav>
      </header>
      ...
      <nav id="menu">
        <ul class="links">
          ...
          <li><a href="landing.html">Introduce</a></li>
      ...
      <div id="main">
        ...
        <section id="one" class="tiles">
          <article>
            <span class="image">
              <img src="resources/introduce/images/pic01.jpg" alt="" />
            </span>
            <header class="major">
          ...
          <article>
            <span class="image">
              <img src="resources/introduce/images/pic02.jpg" alt="" />
            </span>
            <header class="major">
          ...
          <article>
            <span class="image">
              <img src="resources/introduce/images/pic03.jpg" alt="" />
            </span>
            <header class="major">
          ...
          <article>
            <span class="image">
              <img src="resources/introduce/images/pic04.jpg" alt="" />
            </span>
            <header class="major">
